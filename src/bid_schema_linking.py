...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pre_sql_file", type=str, default="src/sql_log/preliminary_sql.txt"
    )
    parser.add_argument(
        "--sql_sl_output", type=str, default="src/schema_linking/sql.json"
    )
    parser.add_argument(
        "--hint_sl_output", type=str, default="src/schema_linking/hint.json"
    )
    parser.add_argument(
        "--LLM_sl_output", type=str, default="src/schema_linking/LLM.json"
    )

    parser.add_argument(
        "--Schema_linking_output", type=str, default="src/schema_linking/schema.json"
    )
    # 解析命令行参数
